...
const RootQuery = new GraphQLObjectType({
  ...
  fields: {
    user: {
      ...
      resolve(parentValue, args) {
        return axios.get(`http://localhost:3002/users/${args.id}`)
          .then(res => res.data);
      }
    },
    company: {
  ...
  fields: {
    addUser: {
      ...
      resolve(parentValue, { firstName, age }) {
        return axios.post('http://localhost:3002/users', { firstName, age })
          .then(res => res.data);
      }
    },
    deleteUser: {
      ...
      resolve(parentValue, args) {
        return axios.delete(`http://localhost:3002/users/${args.userId}`)
          .then(res => res.data);
      }
    }
  }
